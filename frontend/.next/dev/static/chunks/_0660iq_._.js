...
"[project]/src/app/(painel)/alpinistas/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AlpinistasPage() {
    _s();
    // Nossos "estados" (variáveis que o React monitora para atualizar a tela)
    const [alpinistas, setAlpinistas] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    // O useEffect com array vazio [] roda apenas uma vez, assim que a página abre.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AlpinistasPage.useEffect": ()=>{
            buscarAlpinistas();
        }
    }["AlpinistasPage.useEffect"], []);
    // Função que vai no Django buscar os dados
    const buscarAlpinistas = async ()=>{
        try {
            // 1. Pegamos o crachá (Token) que guardamos no Cookie
            ...
            // 2. Fazemos o GET na rota do Django, enviando o Token no cabeçalho (Headers)
            const resposta = await fetch("http://localhost:8000/api/alpinistas/", {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    // O "Bearer" é o padrão que o SimpleJWT do Django exige
                    "Authorization": `Bearer ${token}`
                }
            });
            if (!resposta.ok) {
                throw new Error("Não foi possível carregar a lista de alpinistas.");
            }
            // 3. Convertemos a resposta para JSON e guardamos no nosso estado
            const dados = await resposta.json();
            setAlpinistas(dados);
        } catch (error) {
            setErro(error.message);
        } finally{
            // Independentemente de dar certo ou errado, paramos o "carregando"
            setCarregando(false);
        }
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    carregando && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "Carregando dados do banco..."
                    }, void 0, false, {
                        fileName: "[project]/src/app/(painel)/alpinistas/page.tsx",
                        lineNumber: 101,
                        columnNumber: 32
                    ...
                    erro && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-10 text-center text-red-500 font-medium bg-red-50",
                        children: erro
                    }, void 0, false, {
                        fileName: "[project]/src/app/(painel)/alpinistas/page.tsx",
                        lineNumber: 105,
                    ...
                    !carregando && !erro && alpinistas.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-10 text-center text-gray-500",
                        children: 'Nenhum alpinista cadastrado ainda. Clique em "Novo Alpinista" para começar.'
                    }, void 0, false, {
                        fileName: "[project]/src/app/(painel)/alpinistas/page.tsx",
                        lineNumber: 110,
                        columnNumber: 69
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: alpinistas.map((alpinista)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "hover:bg-gray-50 transition-colors",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-6 py-6 flex items-center gap-4",
                                                    children: [
                                                        alpinista.foto ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                            src: alpinista.foto,
                                                            alt: `Foto de ${alpinista.nome}`,
                                                            ...
                                                            className: "w-12 h-12 rounded-full bg-blue-50 text-escalada-azul flex items-center justify-center font-bold text-sm border border-blue-100",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: alpinista.email || "Não informado"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(painel)/alpinistas/page.tsx",
                                                    lineNumber: 141,
                                                    columnNumber: 41
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-6 py-6 text-sm text-gray-500",
                                                    children: alpinista.telefone || "Não informado"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(painel)/alpinistas/page.tsx",
                                                    lineNumber: 144,
                                                    columnNumber: 41
...
_s(AlpinistasPage, "ujDdwAjHUx7feYfpkKYjBjmxZLw=");
_c = AlpinistasPage;
var _c;
__turbopack_context__.k.register(_c, "AlpinistasPage");
...
//# sourceMappingURL=_0660iq_._.js.map